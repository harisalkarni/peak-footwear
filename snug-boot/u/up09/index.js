...
window.addEventListener('next:initialized', function () {
    ...
    var acceptUrl  = document.querySelector('meta[name="next-upsell-accept-url"]')?.content  || '/snug-boot/thank-you';
    var declineUrl = document.querySelector('meta[name="next-upsell-decline-url"]')?.content || '/snug-boot/thank-you';
