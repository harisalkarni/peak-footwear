...
window.addEventListener('next:initialized', function() {
    ...
    const acceptUrl = document.querySelector('meta[name="next-upsell-accept-url"]')?.content || '/lorax-bogo/u/up04';
    const declineUrl = document.querySelector('meta[name="next-upsell-decline-url"]')?.content || '/lorax-bogo/u/up04';
