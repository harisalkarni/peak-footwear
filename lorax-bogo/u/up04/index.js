// Next SDK Integration - Upsell Page (Premium Insoles - BOGO Campaign)

// Package ID Calculator for Premium Insoles (BOGO Campaign)
function calculatePackageId(size) {
    ...
    if (isNaN(packageId) || packageId < 294 || packageId > 297) {
...
window.addEventListener('next:initialized', function() {
    ...
    const acceptUrl = document.querySelector('meta[name="next-upsell-accept-url"]')?.content || '/lorax-bogo/u/up05';
    const declineUrl = document.querySelector('meta[name="next-upsell-decline-url"]')?.content || '/lorax-bogo/u/up05';
...
console.log('Peak Footwear Upsell Page 4 (Premium Insoles - BOGO Campaign) JavaScript with Next SDK integration loaded successfully');
