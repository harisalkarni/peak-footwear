// Next SDK Integration - Upsell Page (Bunion Corrector & Big Toe Straightener - BOGO Campaign)

// Package ID for Bunion Corrector - Single SKU (BOGO Campaign)
const BUNION_CORRECTOR_PACKAGE_ID = 298;
...
window.addEventListener('next:initialized', function() {
    ...
    const acceptUrl = document.querySelector('meta[name="next-upsell-accept-url"]')?.content || '/lorax-bogo/thank-you';
    const declineUrl = document.querySelector('meta[name="next-upsell-decline-url"]')?.content || '/lorax-bogo/thank-you';
...
console.log('Peak Footwear Upsell Page 5 (Bunion Corrector - BOGO Campaign) JavaScript with Next SDK integration loaded successfully');
