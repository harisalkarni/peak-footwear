// Peak Footwear - Lorax Pro Landing Page JavaScript
// Replicating Peak functionality

console.log('Peak Footwear Lorax Pro page JavaScript loaded');
...
window.addEventListener('load', function() {
    ...
    if (window.UnifiedTrackingBridge && window.UnifiedTrackingBridge.track) {
        const productData = {
            cartLines: [{
                packageId: 'lorax-pro-offer',
                product: {
                    sku: 'LORAX-PRO-BUNDLE',
                    title: 'Lorax Pro Barefoot Shoes',
    ...
    if (window.dataLayer) {
        window.dataLayer.push({
            ...
            ecommerce: {
                ...
                value: 49.95,
                items: [{
                    item_id: 'lorax-pro-bundle',
                    item_name: 'Lorax Pro Barefoot Shoes',
...
console.log('Peak Footwear Lorax Pro page JavaScript initialization complete');
